        ...
        <div class="sidebar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item p-2">
              <a href="{{url('/admin/dashboard')}}" class="nav-link px-2 text-light">
                <i class="fas fa-chart-area fa-2x mr-2"></i>
                <span class="text-white font">Dashboard</span>
              </a>
            </li>
            ...
            <li class="nav-item p-2">
              <a href="{{url('/admin/dashboard')}}" class="nav-link px-2 text-light">
                ...
                <span class="text-white font">Jumlah Sampah</span>
              </a>
            </li>

            <li class="nav-item p-2">
              <a href="{{url('/admin/pengepul')}}" class="nav-link px-2 text-light">
                <i class="fas fa-edit fa-2x mr-2"></i>
                <span class="text-white font">Cek Pengepul</span>
              </a>
            </li>

            <li class="nav-item p-2">
              <a href="{{url('/admin/pengumpul')}}" class="nav-link px-2 text-light">
                <i class="fas fa-user fa-2x mr-2"></i>
                <span class="text-white font">Cek Pengumpul</span>
              </a>
            </li>
            ...
            <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
              <div class="modal-content bg-gradient-success">
                <div class="modal-header">
                  <h6 class="modal-title text-white" id="modal-title-notification">Pemberitahuan</h6>
                ...
                <div class="modal-body">
                  <div class="py-3 text-center">
                    <i class="fas fa-check-circle fa-7x text-white"></i>
