          ...
          <ul class="navbar-nav">
            <li class="text-center">
              <p class="h1 text-center my-0 text-white" style="font-size: 7rem;"><i class="fas fa-user-circle"></i></p>
                ...
                <div class="badge badge-@if(Auth::user()->status=='aktif'){{'success'}}@else{{'danger'}}@endif px-4 py-2 text-center">Status : {{Auth::user()->status}}</div> 
                <hr>
            </li>

            <li class="nav-item p-2">
              <a href="{{url('/pengepul/dashboard')}}" class="nav-link px-2 text-light">
                <i class="fas fa-paper-plane fa-2x mr-2"></i>
                <span class="text-white font">Kirim Data</span>
              </a>
            </li>

            <li class="nav-item p-2">
              <a href="{{url('/pengepul/histori')}}" class="nav-link px-2 text-light">
